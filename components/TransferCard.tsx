import { Box, Card, Flex, Heading, Input, Text , useColorModeValue} from "@chakra-ui/react";
...
export default function TransferCard() {
    ...
    return (
        <Card w={"50%"} p={20} mt ={20} bgGradient='linear(to-r, green.100, pink.100)'>
            ...
            />
            <Box mt={8} color={useColorModeValue('gray.50', 'gray.900')}>
                {address ? (
                    <TransferButton
