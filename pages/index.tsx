...
import { Box, Button, Container, Flex, Heading, SimpleGrid, Stack, Text , extendTheme , ColorModeScript} from "@chakra-ui/react";
...
const Home: NextPage = () => {
  ...
  return (
    <Container maxW={"1440px"} bgGradient='linear(to-r, green.100, pink.100)'>
      <Flex h={"75vh"} px={10} borderRadius={20} >
        <Flex flexDirection={"row"}>
          ...
          <Flex flexDirection={"column"} justifyContent={"center"} w={"60%"}>
            <Stack spacing={4}>
              <Heading fontSize={"xl"}>Transfer Dapp</Heading>
              ...
              <Link href={"/transfer"}>
                <Button w={"80%"} bgGradient='linear(to-r, green.200, pink.500)'>Make a Transfer</Button>
              </Link>
            </Stack>
          </Flex>
        </Flex>
